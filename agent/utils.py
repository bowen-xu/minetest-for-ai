...
import numpy as np
from .proto import objects_pb2 as pb_objects
from .proto.objects_pb2 import KeyType
...
def pack_pb_action(action: Dict[str, Any]):
    """
    pack action into protobuf object
    Args:
        action: dict with keys from KEY_MAP and "MOUSE". Keys are strings.
            If a key is "MOUSE", the value should be the mouse movement as a 2-element tuple.
            Otherwise, a key should be a string from KEY_MAP.keys(), and the value should be a boolean.
    """
