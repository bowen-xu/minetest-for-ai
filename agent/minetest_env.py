...
class Minetest(gym.Env):
    ...
    def _set_minetest_dirs(self, minetest_root):
        ...
        if self.minetest_root is None:
            ...
            candidate_minetest_executable = os.path.join(os.path.dirname(os.path.dirname(__file__)),"bin","minetest")
        ...
        if self.minetest_root is None: 
            ...
            try:
                candidate_minetest_executable = pkg_resources.resource_filename(__name__,os.path.join("minetest","bin","minetest"))
                if os.path.isfile(candidate_minetest_executable):
